...
export default class JBRefreshBaseView extends Component {
	...
	constructor(props) {
		...
		this.imageViewArray = this.props.pullImageView ? this.props.pullImageView : imageViews.pullImageView('light');
		this.imageBottomViewArray = this.props.loadMoreView ? this.props.loadMoreView : imageViews.loadMoreView('light');

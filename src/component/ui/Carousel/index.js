...
export default class Carousel extends UIComponent {
	...
	_renderContent = () => {
		...
		let wh = {
			width: horizontal ? size.width * (childrenLength + (childrenLength > 1 ? 2 : 0)) : size.width,
			height: horizontal ? size.height : size.height * (childrenLength + (childrenLength > 1 ? 2 : 0))
		}

...
import Wedge from '../../../component/ui/PieChat/Wedge'
import { PieChat } from 'component'
...
export default class TestART extends Component {
	...
	render() {
		...
		let colors = ["red", "blue"];
		let linearGradient = new LinearGradient(colors, 0, 0, 100, 100);
		let colors1 = ["#393A3F", "#222222"];
		// colors1 = ['white', 'black'];
		let width = 100, height = 100;
		// let { width, height } = Dimensions.get("window");

		let radialGradient = new RadialGradient(colors1, width * 0.5, height * 0.5, height * 0.5, height * 0.5, width * 0.5, height * 0.5);
		...
		return (
			<ScrollView style={{ flex: 1, margin: 20 }}>
				...
				<Surface width={100} height={40} >
					<ART.Text strokeWidth={1} stroke='#000' font='bold italic 32px Heiti SC' > Swipe</ART.Text>
				</Surface>

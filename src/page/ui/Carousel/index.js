...
export default class Page extends Component {
	render () {
		let arr4 = [
			<Image source={require('./img/carousel1.jpg')} style={{width: width, height: 170}} />,
			<Image source={require('./img/carousel2.jpg')} style={{width: width, height: 170}} />,
			<Image source={require('./img/carousel3.jpg')} style={{width: width, height: 170}} />,
			<Image source={require('./img/carousel4.jpg')} style={{width: width, height: 170}} />
		], arr3 = [
			<Image source={require('./img/carousel1.jpg')} style={{width: width, height: 170}} />,
			<Image source={require('./img/carousel2.jpg')} style={{width: width, height: 170}} />,
			<Image source={require('./img/carousel3.jpg')} style={{width: width, height: 170}} />,
